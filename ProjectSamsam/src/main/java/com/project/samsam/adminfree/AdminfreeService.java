...
public interface AdminfreeService {
	...
	public List<Myfree_authVO> selectAuth_detail_re(int confirm_no);			//상세보기 페이지 redirect할 때 사용
	public Myfree_doc_confirmVO selectConfirm_detail_re(int confirm_no);	//상세보기 페이지 redirect할 때 사용
